...
Things only the human can do: create accounts, pay for services, provide API
keys, set DNS records, approve designs, sign things. Agents: add items the
moment you hit one (with enough detail that the user can act without asking),
